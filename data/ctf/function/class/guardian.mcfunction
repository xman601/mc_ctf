...
item replace entity @s hotbar.0 with diamond_axe[item_name='{"text":"Greataxe"}',lore=['{"text":"Like a normal axe, but greater","color":"gray","italic":false}'],unbreakable={show_in_tooltip:false},custom_data={CTF.NoDrop:true}] 1
