...
item replace entity @s weapon.offhand with shield[unbreakable={show_in_tooltip:false},custom_data={CTF.NoDrop:true}] 1
item replace entity @s hotbar.0 with wooden_axe[item_model="minecraft:iron_axe",item_name='{"text":"Greataxe"}',lore=['{"text":"Like a normal axe, but greater","color":"gray","italic":false}'],unbreakable={show_in_tooltip:false},custom_data={CTF.NoDrop:true}] 1
