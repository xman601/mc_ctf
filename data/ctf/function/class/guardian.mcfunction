...
item replace entity @s hotbar.0 with netherite_axe[item_name='{"text":"Greataxe"}',unbreakable={},consumable={consume_seconds:1000000000,animation:"block"},custom_data={CTF.NoDrop:true,CTF.BlockSword:false}] 1
