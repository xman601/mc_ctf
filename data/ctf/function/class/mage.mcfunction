...
item replace entity @s hotbar.0 with music_disc_pigstep[!jukebox_playable,item_model="blaze_rod",item_name='{"text":"Wand of Fire"}',rarity="rare",enchantment_glint_override=true,consumable={consume_seconds:1000000000,animation:"spear"},max_stack_size=64,custom_data={CTF.NoDrop:true,CTF.Fireball:true}] 1
