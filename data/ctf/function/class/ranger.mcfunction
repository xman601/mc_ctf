...
item replace entity @s hotbar.1 with stone_axe[item_name='{"text":"Woodsman\'s Axe"}',lore=['{"text":"Reliable, heavy, and cuts down anything in your way","color":"gray","italic":false}'],unbreakable={show_in_tooltip:false},consumable={consume_seconds:1000000000,animation:"block"},custom_data={CTF.NoDrop:true,CTF.BlockSword:false}]
