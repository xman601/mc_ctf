...
item replace entity @s hotbar.0 with wooden_sword[item_model="minecraft:iron_sword",item_name='{"text":"Iron Dagger"}',lore=['{"text":"Reliable iron, gets the job done","color":"gray","italic":false}'],unbreakable={show_in_tooltip:false},custom_data={CTF.NoDrop:true}] 1
...
item replace entity @s hotbar.3 with potion[!use_remainder,potion_contents={potion:"minecraft:water",custom_color:15263969,custom_effects:[{id:"minecraft:invisibility",amplifier:0,duration:500}]},custom_name='{"italic":false,"text":"Potion of Invisibiility"}',custom_data={CTF.NoDrop:true,CTF.InvisibilityPotion:true}] 1
