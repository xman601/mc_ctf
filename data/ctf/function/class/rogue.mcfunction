...
item replace entity @s hotbar.0 with diamond_sword[item_name='{"text":"Diamond Dagger"}',lore=['{"text":"Gets the job done","color":"gray","italic":false}'],unbreakable={show_in_tooltip:false},custom_data={CTF.NoDrop:true}] 1
