...
item replace entity @s hotbar.0 with iron_sword[item_name={text:"Poison Dagger"},lore=[{text:"Where did you even get the poison?",color:"gray",italic:false},{text:""},{text:"When Hit:",color:"gray",italic:false},{text:" 8% chance to inflict poison",color:"blue",italic:false}],unbreakable={},custom_data={CTF.NoDrop:true,CTF.PoisonDagger:true},tooltip_display={hidden_components:["minecraft:unbreakable"]}] 1
