...
item replace entity @s hotbar.0 with iron_sword[unbreakable={show_in_tooltip:false},custom_data={CTF.NoDrop:true}] 1
item replace entity @s hotbar.1 with crossbow[item_name='{"text":"Crossbow","color":"white"}',unbreakable={show_in_tooltip:false},enchantments={levels:{"minecraft:quick_charge":2,"minecraft:piercing":1},show_in_tooltip:false},enchantment_glint_override=false,custom_data={CTF.NoDrop:true}] 1
