...
item replace entity @s hotbar.0 with iron_sword[unbreakable={},custom_data={CTF.NoDrop:true},tooltip_display={hidden_components:["minecraft:unbreakable"]}] 1
item replace entity @s hotbar.1 with crossbow[item_name={text:"Crossbow",color:"white"},unbreakable={},enchantments={"minecraft:quick_charge":2,"minecraft:piercing":1},enchantment_glint_override=false,custom_data={CTF.NoDrop:true},tooltip_display={hidden_components:["minecraft:enchantments","minecraft:unbreakable"]}] 1
